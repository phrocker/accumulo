...
public class SequentialRFile {

  public static final String EXTENSION = "rf";

  private static final Logger log = LoggerFactory.getLogger(SequentialRFile.class);

  private SequentialRFile() {}
  ...
  private static class LocalityGroupReader extends LocalityGroup implements FileSKVIterator {
    ...
    private CachableBlockFile.CachedBlockRead getDataBlock(MultiLevelIndex.IndexEntry indexEntry)
        throws IOException {
