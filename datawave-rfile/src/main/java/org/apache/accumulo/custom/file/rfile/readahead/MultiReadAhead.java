...
public class MultiReadAhead extends BaseReadAhead {
  ...
  org.apache.accumulo.custom.file.rfile.readahead.FutureReadAhead nextRead = null;

  Deque<org.apache.accumulo.custom.file.rfile.readahead.FutureReadAhead> readAheads =
      new ArrayDeque<>();

  public MultiReadAhead(BlockReadAhead readAhead,
  ...
  @Override
  public org.apache.accumulo.custom.file.rfile.readahead.BlockedRheadAhead peek()
  ...
  @Override
  public org.apache.accumulo.custom.file.rfile.readahead.BlockedRheadAhead getNextBlock()
      throws ExecutionException, InterruptedException {
    var block = nextRead == null ? null : nextRead.get();
    if (!readAheads.isEmpty() || iiter.hasNext()) {
      if (!readAheads.isEmpty()) {
      ...
      if (readAheads.size() <= readAheadCount) {
        ...
        Deque<org.apache.accumulo.custom.file.rfile.readahead.FutureReadAhead> myReadAheads =
            new ArrayDeque<>();
  ...
  private org.apache.accumulo.custom.file.rfile.readahead.FutureReadAhead
      initiateReadAhead(MultiLevelIndex.IndexEntry indexEntry, BlockSupplier dataRetrieval) {
    return new FutureReadAhead(readAhead.submitReadAheadRequest(() -> {
      org.apache.accumulo.custom.file.rfile.readahead.BlockedRheadAhead readAhead =
          new BlockedRheadAhead();
