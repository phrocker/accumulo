...
public class SnowflakeUID extends UID {
     ...
     * @param radix  used for creating a String representation of this ID, such as 10 for decimal and 16 for hexadecimal (the default)
     ...
     *
     * @param nodeId    one-up, 8-bit index value for the staging host responsible for queuing the generation of this UID
     * @param processId one-up, 6-bit index value for the process responsible for queuing the generation of this UID
     * @param threadId  one-up, 6-bit index value for the process thread responsible for queuing the generation of this UID
     ...
     *
     * @param s             string of the UID
     * @param maxExtraParts is the number of pieces of the extra portion to include. -1 means all, 0 means none.
     * @return UID
     */
    @SuppressWarnings("unchecked")
