...
import org.apache.accumulo.core.file.rfile.uids.HashUID;
...
public class CreatorConfiguration {
    ...
    public CreatorConfiguration(HashSet<String> dataTypes, HashSet<String> indexedFieldNames, int shardCount){
    ...
    public void generate(){
        ...
        void generateUids(long number) {
            ...
            for (int i = 0; i < number; i++) {
                UID docId = new HashUID(UUID.randomUUID().toString().getBytes(StandardCharsets.UTF_8), (Date) null);
...
*/
    ...
    public void addInjectedField(String fieldName, String fieldValue,String auth, long numberOfDocs)
    {
        injectedMappings.put(fieldName.toUpperCase(), new FieldInjector(fieldName.toUpperCase(),fieldValue,auth,numberOfDocs));
    }
