...
public class AccumuloOutputFormatTest {
  ...
  public void testMapreduce() throws Exception {
    ...
    // set the max memory so that we ensure we don't flush on the write.
    batchConfig.setMaxMemory(Long.MAX_VALUE);
    OutputConfigurator.setBatchWriterOptions(org.apache.accumulo.core.client.mapred.AccumuloOutputFormat.class, job, batchConfig);
    ...
    org.apache.accumulo.core.client.mapred.AccumuloOutputFormat.setZooKeeperInstance(job, accumulo.getInstanceName(), accumulo.getZooKeepers());
    org.apache.accumulo.core.client.mapred.AccumuloOutputFormat.setConnectorInfo(job, "root", new PasswordToken(secret));
    RecordWriter<Text,Mutation> writer = outputFormat.getRecordWriter(null, job, "Test", null);
