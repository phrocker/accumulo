...
public class LocalityGroupReader extends LocalityGroupIterator.LocalityGroup
    implements FileSKVIterator {

  private static final Logger log = LoggerFactory.getLogger(LocalityGroupReader.class);
